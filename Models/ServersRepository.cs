namespace ServerManagement.Models
{
    public static class ServersRepository
    {
        private static List<Server> servers = new List<Server>()
        {
            ...
            new Server {  ServerId = 9, Name = "Server9", City = "eGoli" },
            new Server {  ServerId = 10, Name = "Server10", City = "Pretoria" },
            new Server {  ServerId = 11, Name = "Server11", City = "Thekwini" },
            new Server {  ServerId = 12, Name = "Server12", City = "Gqeberha" },
            new Server {  ServerId = 13, Name = "Server13", City = "Gqeberha" },
            new Server {  ServerId = 14, Name = "Server14", City = "cape town" },
            new Server {  ServerId = 15, Name = "Server15", City = "cape town" },
        };
